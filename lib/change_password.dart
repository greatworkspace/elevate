...
class _ChangePasswordState extends State<ChangePassword>
  ...
  final newpasswordconCon = TextEditingController();
    ...
    return Scaffold(
        ...
        body: SafeArea(child: LayoutBuilder(builder: (context, constraints) {
          ...
          Widget continuebtn() {
            if (passwordCon.text != '' &&
                newpasswordCon.text != '' &&
                newpasswordconCon.text != '' &&
                newpasswordCon.text == newpasswordconCon.text) {
              return realcontinue;
            } else {
              return greycontinue;
            }
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  width: myWidth - 20,
                                  child: TextField(
                                    controller: newpasswordconCon,
                                    obscureText: obscure,
                                    onChanged: (value) {
                                      setState(() {
                                        newpasswordconCon.text = value;
                                      });
                                    },
                                    style: TextStyle(
                                        color: mode.brightText1,
