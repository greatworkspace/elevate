                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(width: 1, color: mode.kunleStroke),
                        borderRadius: BorderRadius.circular(5)),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
                          'You have not yet set a pin for the account.',
                          style: TextStyle(
