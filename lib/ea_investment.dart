...
class _EaInvestmentState extends State<EaInvestment> {
  ...
  Widget build(BuildContext context) {
    ...
    if (full_plan['duration'] > 1) {
      full_duration = '${full_plan['duration']} Months';
    } else {
      full_duration = '${full_plan['duration']} Month';
    }
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Maximum of ${full_plan["interest"] ?? 0}% in 12 months',
                                style: TextStyle(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RichText(
                            ...
                            TextSpan(
                                text:
                                    '₦ ${humanizeNo(full_plan["interest_threshold"] ?? 0.0)}',
                                style: TextStyle(
                                  color: mode.brightText1,
                                  fontSize: 13,
                                  fontFamily: GoogleFonts.notoSans().fontFamily,
