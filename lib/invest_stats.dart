...
class InvestStats extends StatefulWidget {
  InvestStats({
    required this.amode,
    required this.index,
  });
  ...
  @override
  _InvestStatsState createState() => _InvestStatsState();
}

dynamic mode = mode;

class _InvestStatsState extends State<InvestStats> {
