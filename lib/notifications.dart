...
final List<Map<String, dynamic>> notifications = [
  {
    'id': 1,
    'text': 'Your deposit on Elevate Plus was successful.',
    'type': 'elevate',
    'time': '09:00 AM',
    'status': 'unread',
  },
  {
    'id': 2,
    'text': 'Your Investment application has been approved, view details.',
    'type': 'investment',
    'time': 'Yesterday',
    'status': 'unread',
  },
  {
    'id': 3,
    'text': 'You have created a new Target (rent).',
    'type': 'target',
    'time': '09:00 AM',
    'status': 'unread',
  },
  {
    'id': 4,
    'text': 'Loan Status (Next Installment in 20 days).',
    'type': 'loan',
    'time': 'Monday, 8th May',
    'status': 'read',
  },
  {
    'id': 5,
    'text': 'You’ve added N 20,000 to your Wallet.',
    'type': 'flexible',
    'time': 'Friday, 5th May',
    'status': 'read',
  },
    ...
    return Scaffold(backgroundColor: mode.background1,
      ...
      Widget AllFeeds() {
          ...
          return SizedBox(
            ...
            child: TextButton(
              ...
              onPressed: () {
                ...
                int iniindex = 1;
                if (notifications[index]['type'] == 'elevate') {
                  iniindex = 2;
                } else if (notifications[index]['type'] == 'target') {
                  iniindex = 3;
                }
                savingsI = iniindex;
                Navigator.push(
        ...
        for (var item in notifications) {
          ...
          if (item['id'] == notifications.length) {
            mydivider = Container();
          }
